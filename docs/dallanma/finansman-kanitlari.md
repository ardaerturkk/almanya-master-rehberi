...
Vize başvurusu için finansman kanıtı sunmanın üç resmi yolu var. Hangisinin sana uygun
olduğunu burada karşılaştırmalı olarak görebilirsin. Ana adım sırası için
[Adım 17: Sperrkonto Açma](/faz-4-vize/17-sperrkonto)'ya bak — bu sayfa onun alternatiflerini
derinlemesine anlatıyor.
:::

## Üçü de resmi olarak geçerli mi?

Evet — Auswärtiges Amt'ın finansman kanıtı (Finanzierungsnachweis) sayfaları üçünü de resmi
alternatif olarak listeliyor. Hangisinin senin durumunda pratik olduğu değişir.
...
Detaylı sağlayıcı karşılaştırması (Fintiba, Expatrio, Coracle, Deutsche Bank) ve güncel tutar
için [Adım 17](/faz-4-vize/17-sperrkonto) sayfasına bak.
...
- Almanya'da güvendiğin, mali durumu yeterli bir yakının varsa → **Verpflichtungserklärung**
  genelde en ucuz ve hızlı yol.
- Yeterli burs kazandıysan → **Burs** belgesi yeterli, ekstra maliyet yok.
- İkisi de yoksa → **Sperrkonto** her zaman açık bir seçenek, tamamen kendi başına
  yürütebilirsin.
